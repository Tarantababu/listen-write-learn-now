    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="mb-12">
        <div className="space-y-2 mb-8">
          <h1 className="text-2xl font-semibold">{selectedLanguage} Learning Plan</h1>
          <p className="text-muted-foreground">Follow the structured curriculum to build your skills step by step.</p>
        </div>
