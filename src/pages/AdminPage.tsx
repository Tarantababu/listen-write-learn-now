...
import RoadmapsManager from '@/components/admin/RoadmapsManager';
import RoadmapNodeEditor from '@/components/admin/RoadmapNodeEditor';
...
const AdminPage: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/roadmaps/:roadmapId" element={<RoadmapNodeEditor />} />
    </Routes>
  );
};
