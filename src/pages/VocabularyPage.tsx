              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs sm:text-sm font-medium text-primary truncate">
                    {audioQueue.length > 0 && currentQueueIndex < audioQueue.length
                  ...
                  <div className="text-xs text-muted-foreground">
                    {audioQueue.length > 0
                      ? `${currentQueueIndex + 1}/${audioQueue.length} • ${_isShuffleMode ? "Shuffled" : "Original"} • ${settings.selectedLanguage}`
                      : `${settings.selectedLanguage} playlist`}
                  </div>
                </div>
