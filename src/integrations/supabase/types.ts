...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      user_word_progression: {
        Row: {
          acquisition_velocity: number | null
          contextual_strength: Json | null
      ...
      vocabulary_progression_sessions: {
        Row: {
          completed_at: string | null
          created_at: string | null
          current_complexity_level: number | null
          id: string
          language: string
      ...
      word_progression_mappings: {
        Row: {
          ...
          id: string
          language: string
          prerequisite_words: string[] | null
