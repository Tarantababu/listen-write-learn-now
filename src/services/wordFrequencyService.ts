...
export class WordFrequencyService {
  ...
  private static readonly COMMON_WORDS = {
    german: [
      ...
      'bis', 'mehr', 'durch', 'man', 'sein', 'wurde', 'sei', 'ich', 'du',
      'wir', 'ihr', 'Sie', 'mein', 'dein', 'unser', 'euer', 'dieser', 'diese', 'dieses',
      'jener', 'jene', 'jenes', 'welcher', 'welche', 'alle', 'viele', 'einige', 'wenige', 'andere',
      'neue', 'große', 'kleine', 'gute', 'schlechte', 'erste', 'letzte', 'nächste', 'vorige', 'hier',
      'dort', 'da', 'wo', 'wohin', 'woher', 'heute', 'morgen', 'gestern', 'jetzt', 'dann',
      // Additional common words to reach 200+
      'schon', 'wieder', 'immer', 'oft', 'manchmal', 'können', 'müssen', 'sollen', 'wollen', 'dürfen',
      'mögen', 'lassen', 'gehen', 'kommen', 'sehen', 'hören', 'sagen', 'sprechen', 'fragen', 'antworten',
      'geben', 'nehmen', 'bringen', 'holen', 'machen', 'tun', 'arbeiten', 'leben', 'wohnen', 'fahren',
      'reisen', 'kaufen', 'verkaufen', 'bezahlen', 'kosten', 'Haus', 'Wohnung', 'Zimmer', 'Küche', 'Bad',
      'Schlafzimmer', 'Garten', 'Straße', 'Stadt', 'Land', 'Auto', 'Bus', 'Zug', 'Flugzeug', 'Schiff',
      'Fahrrad', 'Fuß', 'Hand', 'Kopf', 'Auge', 'Ohr', 'Nase', 'Mund', 'Haar', 'Bein',
      'Arm', 'Herz', 'Familie', 'Vater', 'Mutter', 'Kind', 'Sohn', 'Tochter', 'Bruder', 'Schwester',
      'Großvater', 'Großmutter', 'Freund', 'Freundin', 'Mann', 'Frau', 'Junge', 'Mädchen', 'Baby', 'Leute',
      'Person', 'Mensch', 'Name', 'Jahr', 'Monat', 'Woche', 'Tag', 'Stunde', 'Minute', 'Zeit',
      'Uhr', 'Morgen', 'Mittag', 'Abend', 'Nacht'
    ],
    spanish: [
      ...
      'antes', 'sido', 'bien', 'aquí', 'quien', 'durante', 'siempre', 'día', 'ella',
      'tres', 'sí', 'dijo', 'cada', 'menos', 'nuevo', 'debe', 'parte', 'entre',
      'vida', 'casi', 'país', 'según', 'contra', 'bajo', 'estado', 'caso', 'años', 'grupo',
      'momento', 'mismo', 'trabajo', 'gobierno', 'mientras', 'empresa', 'después', 'forma', 'agua', 'casa',
      'curso', 'yo', 'tú', 'nosotros', 'vosotros', 'ellos', 'ellas', 'mi', 'tu', 'nuestro',
      'vuestro', 'este', 'esta', 'estos', 'estas', 'ese', 'esa', 'esos', 'esas', 'aquel',
      'aquella', 'grande', 'pequeño', 'bueno', 'malo', 'nuevo', 'viejo', 'joven', 'mayor', 'menor',
      'mejor', 'peor', 'primero', 'último', 'próximo', 'anterior', 'hoy', 'ayer', 'mañana', 'entonces',
      'aquí', 'allí', 'allá', 'adonde', 'cómo', 'cuándo', 'por qué', 'para qué', 'poder', 'deber',
      'querer', 'conocer', 'ver', 'oír', 'hablar', 'escuchar', 'preguntar', 'responder', 'entender', 'aprender',
      'enseñar', 'estudiar', 'leer', 'escribir', 'pensar', 'recordar', 'olvidar', 'hombre', 'mujer', 'niño',
      'niña', 'persona', 'gente', 'padre', 'madre', 'hijo', 'hija', 'hermano', 'hermana', 'abuelo',
      'abuela', 'amigo', 'amiga', 'nombre', 'edad'
    ],
    french: [
      ...
      'politique', 'donner', 'sous', 'puis', 'dire', 'contre', 'celui', 'moment', 'façon', 'social',
      'deux', 'pendant', 'depuis', 'long', 'encore', 'force', 'beaucoup', 'quelque', 'trouver', 'cas',
      'seul', 'partir', 'groupe', 'lieu', 'vers', 'tant', 'fois', 'je', 'tu', 'elle',
      ...
      'sœur', 'ami', 'amie', 'eau', 'pain', 'viande', 'légume', 'fruit', 'lait', 'café',
      'thé', 'vin'
    ],
    italian: [
      ...
      'loro', 'mio', 'tuo', 'suo', 'nostro', 'vostro', 'questi', 'quelle', 'buono', 'cattivo',
      'bello', 'brutto', 'giovane', 'vecchio', 'primo', 'ultimo', 'prossimo', 'oggi', 'ieri', 'domani',
      'adesso', 'sempre', 'mai', 'spesso', 'qualche volta', 'già', 'ancora', 'qui', 'qua', 'lì',
      'là', 'dovunque', 'sopra', 'sotto', 'davanti', 'dietro', 'accanto', 'vicino', 'lontano', 'dentro',
      'fuori', 'durante', 'potere', 'dovere', 'volere', 'sapere', 'conoscere', 'vedere', 'sentire', 'parlare',
      'ascoltare', 'chiedere', 'rispondere', 'capire', 'imparare', 'insegnare', 'studiare', 'leggere', 'scrivere', 'pensare',
      'ricordare', 'dimenticare', 'andare', 'venire', 'stare', 'rimanere', 'partire', 'arrivare', 'entrare', 'uscire',
      'salire', 'scendere', 'mangiare', 'bere', 'dormire', 'svegliarsi', 'alzarsi', 'vestirsi', 'lavarsi', 'padre',
      'madre', 'figlio', 'figlia', 'fratello', 'sorella', 'nonno', 'nonna', 'zio', 'zia', 'cugino',
      'cugina', 'marito', 'moglie', 'fidanzato', 'fidanzata', 'amico', 'amica', 'collega', 'vicino'
    ],
    portuguese: [
      ...
      'essa', 'num', 'nem', 'meu', 'às', 'minha', 'têm', 'essas', 'esses', 'aquele',
      'aquela', 'aqueles', 'aquelas', 'isto', 'isso', 'aquilo', 'nosso', 'nossa', 'nossos', 'nossas',
      'vosso', 'vossa', 'vossos', 'vossas', 'dele', 'dela', 'deles', 'delas', 'nele', 'nela',
      'neles', 'nelas', 'deste', 'desta', 'destes', 'tu', 'você', 'nós', 'vocês', 'elas',
      'me', 'te', 'lhe', 'vos', 'lhes', 'mim', 'ti', 'si', 'conosco', 'convosco',
      'consigo', 'comigo', 'contigo', 'grande', 'pequeno', 'bom', 'mau', 'novo', 'velho', 'jovem',
