...
const LearningOptionsMenu: React.FC<LearningOptionsMenuProps> = ({
  ...
  return (
    <div className="flex flex-col h-full max-h-[85vh] bg-background">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div className="flex-1 min-w-0">
              <h2 className="text-xl font-bold text-foreground truncate">{exerciseTitle}</h2>
          ...
          <div className="space-y-3">
            <div className="space-y-2">
              <p className="text-base font-medium">Choose Your Learning Path</p>
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground bg-muted/30 rounded-lg p-3">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">Step 1: Choose learning mode</span>
              </div>
              <div className="flex items-center gap-2">
            ...
            {loadingAnalysisCheck && (
              <motion.div 
                initial={{ opacity: 0 }} 
                animate={{ opacity: 1 }} 
                className="flex items-center justify-center gap-2 mt-3 text-sm font-medium text-primary bg-primary/10 rounded-lg p-3"
              >
      ...
      <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6 practice-content">
      ...
      {/* Fixed Footer - Upgrade Banner for Free Users */}
      {!analysisAllowed && !isSubscribed && (
        <motion.div 
          initial={{ opacity: 0, y: 10 }} 
          animate={{ opacity: 1, y: 0 }} 
          transition={{ duration: 0.3, delay: 0.5 }} 
          className="flex-shrink-0 border-t border-border/50 bg-amber-50 border-amber-200 text-amber-800 dark:bg-amber-950/20 dark:border-amber-800/40 dark:text-amber-300"
        >
          <div className="p-6">
