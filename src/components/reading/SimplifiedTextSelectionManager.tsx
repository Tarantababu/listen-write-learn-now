...
import { PureOverlayHighlighter } from './PureOverlayHighlighter';
...
interface SimplifiedTextSelectionManagerProps {
...
export const SimplifiedTextSelectionManager: React.FC<SimplifiedTextSelectionManagerProps> = ({
  children,
  onCreateDictation,
  ...
  const processSelection = useCallback(() => {
    ...
    if (rawText.length > 0) {
      // Preserve the exact selected text
