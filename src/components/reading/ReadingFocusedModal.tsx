...
const MOBILE_READING_TABS = [
  ...
  { id: 'analyze', label: 'Analyze', icon: Languages }
];
...
export const ReadingFocusedModal: React.FC<any> = ({
  ...
  const renderMobileTabs = () => (
    <div className="flex border-b border-muted z-20 sticky top-0 bg-background">
      {MOBILE_READING_TABS.map(t => (
        <button
          key={t.id}
          type="button"
          onClick={() => setMobileTab(t.id as any)}
          className={`flex-1 flex flex-col items-center justify-center px-2 py-2 ${mobileTab===t.id?'bg-primary/10 text-primary':'text-muted-foreground hover:bg-accent'} focus-visible:ring transition-all active:bg-primary/20`}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge variant="outline" className="text-xs capitalize">{exercise.difficulty_level}</Badge>
