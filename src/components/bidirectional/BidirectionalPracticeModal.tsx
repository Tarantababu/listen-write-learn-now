              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  <div className="p-4 bg-background rounded-lg border">
                    ...
                    <p className="font-medium text-lg">{exercise.original_sentence}</p>
                    {exercise.original_audio_url && (
                      <div className="mt-3">
                        <AudioPlayer audioUrl={exercise.original_audio_url} />
                      </div>
                  ...
                  <div className="p-4 bg-background rounded-lg border">
                    <p className="text-sm text-muted-foreground mb-2 font-medium">Your back translation:</p>
                    <p className="font-medium text-lg">{userBackTranslation || 'Enter your translation above'}</p>
                  </div>
                </div>
