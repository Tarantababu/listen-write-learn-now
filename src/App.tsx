...
import { ResendContactProvider } from '@/contexts/ResendContactContext';
import { PremiumEmailProvider } from '@/contexts/PremiumEmailContext';
import { CancellationEmailProvider } from '@/contexts/CancellationEmailContext';
...
function App() {
  ...
  useEffect(() => {
    ...
    // Set up history listener for route changes
    ...
    <AuthProvider>
      <SubscriptionProvider>
        <UserSettingsProvider>
          <ResendContactProvider>
            <PremiumEmailProvider>
              <CancellationEmailProvider>
                <ExerciseProvider>
                  <VocabularyProvider>
                    <DirectoryProvider>
